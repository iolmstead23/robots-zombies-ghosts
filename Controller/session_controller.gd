...
const HexGridControllerScript = preload("res://Controller/hex_grid_controller.gd")
const NavigationControllerScript = preload("res://Controller/navigation_controller.gd")
const DebugControllerScript = preload("res://Controller/debug_controller.gd")
